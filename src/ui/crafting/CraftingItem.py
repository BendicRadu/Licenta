...
class CraftingItem:
    ...
    @staticmethod
    def get_empty_cell():
        item = CraftingItem(GameVars.TileCode.NaN.value, None)
        return item

    def is_empty_cell(self):
        return self.tile_code == GameVars.TileCode.NaN.value and self.crafting_items_required is None

    def is_locked(self):
        return self.unlocked is False
